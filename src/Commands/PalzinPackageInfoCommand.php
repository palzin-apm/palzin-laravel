...
class PalzinPackageInfoCommand extends Command
{
    protected $hidden = true;

    protected $signature = 'palzin:package-info';
    ...
    public function __construct()
    {
        ...
        $this->guzzle = new Client([
            ...
            'headers' 	  => [
                ...
                'X-Palzin-Key' => $this->key,
                'X-Palzin-Version' => PalzinServiceProvider::VERSION,
            ],
        ]);
    }
